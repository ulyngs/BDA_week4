...
Here are some commands for converting dates into Unix values. 

However, if you need to work with time and dates, you should read through the relevant chapter in R for Data Science (https://r4ds.had.co.nz/dates-and-times.html) and use the 'lubridate' package, to make your life easy!
